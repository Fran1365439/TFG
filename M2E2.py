# -*- coding: utf-8 -*-
"""
Created on Sun Mar 24 17:54:39 2019
...
def solucionExacta(x):
    ...
    """
    s = np.log(2+np.sqrt(3))
    
    return (1/2)*(np.e**(x-s)+np.e**(-(x-s))-2)
...
dfT.to_excel("M2E2.xlsx",index = False)

#Tambien se puede generar la tabla automáticamente en TeX
dfT.to_latex("M2E2.tex",index = False)